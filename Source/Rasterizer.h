...
namespace nmj
{
	...
	/**
	 * Blit output buffer to screen buffer.
	 *
	 * Pixels are stored in native 32bit color format. Output buffer is accessed
	 * in the following pattern:
	 *
	 * char *pixel_address = (char *)output;
	 * pixel_address += y * pitch + x * 4;
	 *
	 * You can split the work into N amount of calls, which can be processed
	 * in parallel.
	 */
